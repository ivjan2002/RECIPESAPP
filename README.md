Recipe App
Description
Recipe App is a web application that allows users to view, add, delete, and manage their own recipes. Users can register, log in, access all available recipes in the app, as well as view their own personal recipes. The application is developed using the Flask framework in Python, providing easy access and management of recipes.
